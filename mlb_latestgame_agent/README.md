# mlb_latestgame_agent

Agent that checks for the latest completed MLB game and triggers an incremental load if new games are available.

## File

`check_latest_game.py`

## Usage

```bash
python check_latest_game.py
```
