...
SELECT
    ...
    -- Team dimension keys
    dt_home.team_id                             AS home_team_key,
    dt_away.team_id                             AS away_team_key,
    ...
    gd.home_pitching_runs_allowed               AS home_team_errors,
    gd.away_pitching_runs_allowed               AS away_team_errors,
...
-- Game status dimension
LEFT JOIN {{ ref('dim_game_status') }} dgst
    ON g.coded_game_state = dgst.status__status_code
