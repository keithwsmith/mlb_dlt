...
Core dlt-based ELT loader that pulls data from the MLB Stats API and loads it into a SQL Server data warehouse. Supports games, teams, players, rosters, stats, drafts, awards, transactions, umpires, and more.
...
```bash
python mlb_load.py <resource> [--start-year YYYY] [--end-year YYYY]
```
